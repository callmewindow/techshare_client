    ...
    <el-card>
      ...
      <div id="main">
        ...
        <el-row :gutter="20" id="info">
          ...
          <el-col :xs="{span:0,offset:0}" :sm="{span:6,offset:0}" :md="{span:9,offset:0}" :lg="{span:13,offset:0}"
                  :xl="{span:13,offset:0}">
            <div></div>
          </el-col>
        </el-row>
              ...
              <div class="eachItem">
                <el-card shadow="always" class="box-card">
                  <div slot="header" class="clearfix">
                    <el-link id="titleText_paper" @click="toDetail(item._id)" class="link">{{item.paperTitle |
                      titleEllipsis}}
                    </el-link>
                  </div>
                  <div class="textItem">
          ...
          <el-tab-pane label="专利成果" name="second" @click="setSelectPatent" value="专利">
            ...
            <div v-for="item in expert.patentList" :key="item.ID">
              <div class="eachItem">
                <el-card shadow="always" class="box-card">
                  <div slot="header" class="clearfix">
                    <el-link id="titleText_patent" @click="toDetail(item._id)" class="link">{{item.patentTitle |
                      titleEllipsis}}
                    </el-link>
                  </div>
                  <div class="textItem">
